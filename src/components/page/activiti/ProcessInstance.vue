  ...
  <div class="content-wrapper">
    <div class="container" v-loading="loading">
      ...
      <el-table :data="tableData" border stripe height="300" class="table" ref="multipleTable" header-cell-class-name="table-header">
        ...
        <el-table-column prop="id" label="流程实例ID" width="120" show-overflow-tooltip></el-table-column>
        <el-table-column prop="name" label="流程实例名称" width="150" show-overflow-tooltip></el-table-column>
        <el-table-column prop="startDate" label="实例创建时间" width="120" show-overflow-tooltip></el-table-column>
        <el-table-column prop="processDefinitionId" label="流程定义编号" show-overflow-tooltip></el-table-column>
        <el-table-column prop="processDefinitionKey" label="流程定义KEY" show-overflow-tooltip></el-table-column>
        <el-table-column prop="processDefinitionVersion" label="版本" show-overflow-tooltip></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getTableData() {
        this.loading = true;
        http.get("/processInstance/getInstances/"+parseInt(this.query.pageNo-1)+"/"+this.query.pageSize, null)
          .then(res => {
            this.loading = false;
    ...
    watch: {
      ...
      '$route': function (to, from) {
        if (this.$route.fullPath.indexOf('processInstance') > -1) {
          this.getTableData();
        }
      },
    },
