  ...
  <div class="content-wrapper">
    <div class="container" v-loading="loading">
      ...
      <el-table :data="tableData" border stripe height="300" class="table" ref="multipleTable" header-cell-class-name="table-header">
        ...
        <el-table-column prop="processDefinitionID" label="流程定义ID" width="120" show-overflow-tooltip></el-table-column>
        <el-table-column prop="deploymentID" label="部署ID" width="150" show-overflow-tooltip></el-table-column>
        <el-table-column prop="name" label="流程定义名称" width="120" show-overflow-tooltip></el-table-column>
        <el-table-column prop="resourceName" label="流程文件名称" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column label="操作" fixed="right" min-width="170" align="center">
          <template slot-scope="scope">
            <el-button v-hasPermission="'department:edit'" type="text" size="mini" icon="el-icon-edit" @click="edit(scope.row.id)">启动</el-button>
            <el-button v-hasPermission="'department:edit'" type="text" size="mini" icon="el-icon-edit" @click="edit(scope.row.id)">查看</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getTableData() {
        this.loading = true;
        http.get("/processDefinition/getDefinitions", this.query)
          .then(res => {
            this.loading = false;
    ...
    watch: {
      ...
      '$route': function (to, from) {
        if (this.$route.fullPath.indexOf('defintions') > -1) {
          this.getTableData();
        }
      },
    },
